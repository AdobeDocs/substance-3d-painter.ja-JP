...
breadcrumb-title: ''
description: Substance 3D Painterの消しゴムツールを使用すると、3Dモデルからペイントやテクスチャを正確に除去できます。
...
消しゴムは、ペイントツールと共通のパラメーターとビヘイビアーを共有します。 ブラシ、アルファ、ステンシルの各コントロールについて詳しくは、[ペイントツールページ](paint-brush.md)を参照してください。
...
> * Substanceフィルターは、アルファ情報を無視した場合に、ペイント情報を取得できます
> 
...
>[!NOTE]
>
> ペイントツールとは異なり、消しゴムでは、影響を受けるチャンネルを定義することのみが可能です。 シェルフからリソースをロードして各チャンネルに影響を与えることはできません。
