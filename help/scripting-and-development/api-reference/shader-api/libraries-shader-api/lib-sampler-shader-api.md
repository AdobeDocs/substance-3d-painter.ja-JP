...
# ライブラリSampler- シェーダー API

## lib-sampler.glsl

**パブリック関数：** *getAO* *getShadowFactor* *getGlossiness* *getRoughness* *getMetallic* *getAnisotropyLevel* *getAnisotropyAngle* *getOpacity* *getHeight* *getGetGet変位* *getSpecularLevel* *getBaseColor* *getDiffuse* *getSpecularColor* *getScattering* *generateAnisotropicRoughness* *generateDiffuseColor* *generateSpecularColor*
...
チャンネルにデータがない場合のデフォルトの背景色（アルファは0）
