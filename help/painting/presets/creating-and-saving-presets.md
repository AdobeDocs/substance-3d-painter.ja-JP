...
[プロパティウィンドウ](../../interface/properties.md)を使用してブラシパラメーターを微調整し、ブラシ設定をプリセットとして保存して、後ですばやく再利用できるようにします。

>[!NOTE]
>
> [パスツール](../tool-list/path.md)を使用すると、[プロパティパネル](../../interface/properties.md)の「プリセット」セクションが使用できるようになり、パス関連のプリセットにすばやくアクセスできます。 パスプリセットをお気に入りに追加することもできます。 お気に入りの[パスプリセットの管理について詳しくは、ここ](../tool-list/path.md)を参照してください。
...
プロパティウィンドウの現在の値に基づいて、既存のプリセットを更新できます。 [アセット](../../interface/assets/assets.md)ウィンドウでアセットを右クリックし、「現在のツールから更新」を選択してプリセットを更新します。
