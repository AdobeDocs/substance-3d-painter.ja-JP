...
<table>
  <tr style="border: 0;">
    ...
    <td style="border: 0;" valign="top"><strong>説明</strong><br>滴下する錆発生装置は、錆が流れ下がる筋を作り、重力と水の流出によって生じる腐食をシミュレートします。<br><br>滴下錆ジェネレータは、白黒テクスチャを出力します。 そのため、滴る錆効果を生み出すマスクを作成する場合に便利です。<br><br>イメージ入力には、ベイク処理された位置、曲率、および環境オクルージョンが必要です。 <a href="../../../baking/baking.md">ベイク処理に関する詳細情報</a>。</td>
  </tr>
</table>
