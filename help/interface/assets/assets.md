...
* 別のライブラリの場所を追加することもできます。 その場合は、[新しいライブラリの追加](adding-a-new-library.md)をご覧ください。

## 概要

「アセット」ウィンドウは、デフォルトで3つの主要なセクションに分かれています。
...
詳細については、[ナビゲーションページ](navigation.md)を参照してください。
