...
helpx_learn_topic: ""
helpx_tags: ""
title: Photoshopからのブラシプリセットの書き出し
...
1. <b>ABRファイルにエクスポートします。</b>

   ブラシウィンドウの設定メニューを開き、<b>選択したブラシを書き出し</b>を選択します。

   書き出されたABRファイルのファイル名と保存場所を入力するファイルダイアログが表示されます。
