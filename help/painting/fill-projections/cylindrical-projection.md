---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-painter/painting/fill-projections/cylindrical-projection.html"
breadcrumb-title: ''
description: Substance 3D Painterの円筒投影法を使用して、円柱からテクスチャを投影し、テクスチャを円柱オブジェクトに巻き付けることができます。
...
塗りの円筒投影を使用すると、オブジェクトの周囲に画像やパターンを投影できます。 柱や柱に合わせたり、腕などの有機的なシェイプに合わせたりするのに便利です。
...
| **角度** | 円柱の周上の投影のサイズをコントロールします。 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/cylindrical-angle.gif"/></div> |
| **バックフェースカリング** | 背面カリングを有効にすると、円柱に対して直角に投影をカリングできます。 硬さスライダーは、中間角度（完全な90度ではない）での投影の柔らかさを定義します。 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/cylindrical-proj.gif" width="500px"/></div> |
