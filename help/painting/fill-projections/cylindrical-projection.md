...
breadcrumb-title: ''
description: Substance 3D Painterで円柱投影を使用すると、円柱オブジェクトにテクスチャを回り込ませるために、テクスチャを円柱から投影することができます。
...
塗りの円柱投影を使用すると、オブジェクトの周囲に画像やパターンを投影できます。 柱や柱に合わせたり、腕などの有機的なシェイプに合わせたりするのに便利です。
