...
>[!NOTE]
>
> エフェクトを右クリックして並べ替えることができますが、Alt +上向き矢印または下向き矢印を使用すると、並べ替えをすばやく実行できます。

Substance 3D Painterにはいくつかの種類のエフェクトがあります。

* [ジェネレーター](generator.md)
* [ペイント](paint.md)
* [塗りつぶし](fill.md)
* [レベル](levels.md)
* [比較マスク](compare-mask.md)
* [フィルター](filter.md)
* [アンカーポイント](anchor-point.md)
