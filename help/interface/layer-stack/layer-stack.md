...
**レイヤースタック**&#x200B;を使用すると、テクスチャセットのレイヤーを操作できます。 1つのレイヤーには、シーンの3Dオブジェクトにテクスチャを与えるペイントや効果が含まれます。 レイヤーの表示と非表示を切り替えたり、レイヤーをフォルダーに入れたり、不透明度や描画モードを変更したりすることができます。
...
レイヤースタックには、一定の階層のレイヤーが表示されます。一番下のレイヤーが最初にメッシュに描画され、一番上のレイヤーがその後に描画されます。 したがって、スタックの一番上のレイヤーが最後のレイヤーになり、一番下のレイヤーが最初のレイヤーになります。 フォルダーも同じ原則ですが、フォルダーの内容が優先されます。 つまり、フォルダーの内容は、同じレベルのレイヤーよりも先に処理されます。
...
* **ペイントレイヤー** ：この種類のレイヤーは、ブラシやパーティクルでペイントできます
* **塗りつぶしレイヤー** ：このレイヤーにペイントすることはできません。代わりに、マテリアルを読み込んでチャンネルを塗りつぶすことができます。 （例えば、変形を操作してマテリアルを繰り返すこともできます）。
* **フォルダー** ：この種類のレイヤーは、他のレイヤーを含めることを目的としてのみ使用され、主にレイヤースタックの整理に使用されます

各レイヤーで、**マスク**&#x200B;を追加できます。マスクでは、現在のテクスチャセットのチャンネルの特定部分にのみコンテンツを適用できます。\
マスクを手動でペイントするか（ブラシを使用してグレースケールで調整）、フィルターとサブスタンスを使用して、よりダイナミックでプロシージャル的な結果を得ることができます。
...
このドロップダウンの一覧は、[テクスチャセットの設定](../texture-set/texture-set-settings.md)で利用できるチャンネルの一覧に基づいています。

## アクション

![](../../assets/image2020-9-30-12-2-13.png)

右上のアイコンのリストは、 レイヤースタックで実行できる一般的なアクションです。
...
| 新規ペイントレイヤーを作成 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r3-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/image2020-9-30-11-52-41.png"/></div> | 現在選択されているペイントレイヤーの上に新しいレイアウトを作成します。 |
| 新規塗りつぶしレイヤーを作成 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/image2020-9-30-12-0-49.png"/></div> | 現在選択されている塗りつぶしレイヤーの上に新しい[フォルダー](../../painting/fill-projections/fill-projections.md)を作成します。 |
| 新しいスマートマテリアルを追加 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/icon-smartmat.png"/></div> | 現在選択されているレイヤーの上に新しいスマートマテリアルを挿入します。このボタンをクリックするとミニシェルフが開き、現在の[アセット](../../interface/assets/assets.md)で利用可能なスマートマテリアルの一覧を参照できます。 |
