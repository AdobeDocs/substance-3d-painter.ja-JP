...
* Substance 3D Painterを通常どおり実行します（管理者権限なし）。
* UACを無効にします（これは&#x200B;**推奨しません** ）。

>[!NOTE]
>
> 読み込みウィンドウを開くだけで、リソースを読み込むこともできます。
> 
> 1. 「ファイル」メニューをクリックします。
> 1. 「リソースのインポート…」を選択します。
> 1. 読み込みウィンドウで、「Add resources」をクリックしてファイルを選択します。
