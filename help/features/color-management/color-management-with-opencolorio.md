...
breadcrumb-title: ''
description: Substance 3D PainterでOpenColorIOのカラーマネジメントを使用して、パイプライン間で一貫したカラーワークフローを実現する方法について説明します。
helpx_creative_field: ""
helpx_description: Painter > Features > Color management > Color management with OpenColorIO
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: OpenColorIOでのカラーマネジメント
...
| **substance\_3d\_painter\_substance\_material** | マテリアルのカラーマネジメントされたチャンネルに使用されるカラースペースを指定する役割です。 |
| **substance\_3d\_painter\_bitmap\_export\_8bit** | 8ビットテクスチャを書き出すときに使用するカラースペースを指定するロール。 |
...
>[!NOTE]
>
> これらのロールの使用例として、アプリケーションに付属のOCIO設定を使用できます。
